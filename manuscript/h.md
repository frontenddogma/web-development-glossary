...
HTML over the wire
: A term marking the use of HTML instead of JSON to populate web applications, and an umbrella term for Turbo, Stimulus, and Strada, tooling to help use HTML over the wire. Hotwire was presented in 2020 by 37signals. ℹ︎ [hotwired.dev](https://hotwired.dev/)
...
: → _0–9_ for various HTTP status codes
