...
Vim
: A clone, with additions, of the vi text editor program for Unix. Vim is designed for use both from a command-line interface and as a standalone application in a graphical user interface. It was released in 1991 by Bram Moolenaar.&nbsp;[†](#w-vim) ℹ︎&nbsp;[vim.org](https://www.vim.org/)
